...
RIESGO_BASE_SLOT = CAPITAL_INICIAL * 0.015  # 1.5% de riesgo base por slot (45.00€)
...
def ejecutar_motor_cuantitativo_short():
    ...
    for pos in posiciones.get("slots_activos", []):
        ...
        # Rendimiento para SHORT: positivo cuando el precio cae
        ...
        # Protecciones: Mover a Break-Even si el rendimiento supera +1.0%
        ...
        # Cierres (En SHORT se pierde si el precio sube por encima del SL)
    ...
    # Sanitización de seguridad adicional para prevenir desajustes
